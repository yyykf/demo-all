...
public class Main {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(cn.ykf.principle.dip.worst.Main.class);
    ...
    public static void main(String[] args) {
        ...
        List<User> prizeRandomUserList = drawControl.doDraw(new DrawRandom(), users, 3);
        LOGGER.info("随机抽奖，中奖用户名单：{}", prizeRandomUserList);

        List<User> prizeWeightUserList = drawControl.doDraw(new DrawWeight(), users, 3);
